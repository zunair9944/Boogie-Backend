                    ...
                    <div class="card-body">
                        <div class="">
                            <div class="row">
                                ...
                                <!--</div>-->
                                <!--<div id="time-fare-fields"></div>-->
                                <!--<button type="button" id="add-time-fare">Add Time Fare</button>-->
                            ...
                            {{--<div class="form-group col-md-4">
                                ...
                                <!--    {{ Form::number('base_fare', old('base_fare'), ['class' => 'form-control', 'min' => 0, 'step' => 'any', 'required', 'placeholder' => __('message.base_fare') ]) }}-->
                                <!--</div>-->
<!--                               <div class="form-group col-md-4" id="time-fare-fields"></div>-->
<!--<div class="form-group col-md-4">-->
<!--    <button class="btn btn-primary" type="button" id="add-time-fare">Add Time Fare</button>-->
<!--</div>-->
 <div class="form-group col-md-4">
            <button class="btn btn-primary" type="button" id="add-time-fare">Add Time Fare</button>
        </div>
 <div class="form-group" id="time-fare-fields">
            <!-- Existing time fare fields can be displayed here -->
        </div>
    ...
    <script type="text/javascript">
        ...
        // JavaScript to dynamically add and remove time-based fare fields
    $(document).ready(function() {
        let index = 0;

        $('#add-time-fare').click(function() {
            index++;

            const timeFareFields = `
                <div class="time-fare-row">
                    <div class="form-group">
                        <label for="time_fares[${index}][from_time]">From Time *</label>
                        <input type="datetime-local" name="time_fares[${index}][from_time]" class="form-control timepicker" required>
                    </div>
                    <div class="form-group">
                        <label for="time_fares[${index}][to_time]">To Time *</label>
                        <input type="datetime-local" name="time_fares[${index}][to_time]" class="form-control timepicker" required>
                    </div>
                    <div class="form-group">
                        <label for="time_fares[${index}][base_fare]">Base Fare *</label>
                        <input type="number" name="time_fares[${index}][base_fare]" class="form-control" min="0" step="any" required>
                    </div>
                    <div class="form-group col-md-2">
                        <button type="button" class="btn btn-danger remove-time-fare">Remove</button>
                    </div>
                </div>
            `;

            $('#time-fare-fields').append(timeFareFields);
        });

        // Remove time-based fare field on click
        $(document).on('click', '.remove-time-fare', function() {
            $(this).closest('.time-fare-row').remove();
        });

        // Initialize timepicker for all time fields
