                        ...
                        <div class="new-user-info">
                            <div class="row">
                                <div class="form-group col-md-4">
                                 ...
                                 <div class="form-group col-md-4">
                                    {{ Form::label('fees', __('message.fees').' <span class="text-danger">*</span>',['class' => 'form-control-label'], false ) }}
                                    {{ Form::text('fees', old('fees'),[ 'placeholder' => __('message.fees'),'class' =>'form-control','required']) }}
                                </div>
