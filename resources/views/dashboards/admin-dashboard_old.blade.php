                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height">
                         <a href={{route('rider.index')}} style="color: inherit;">
                            <div class="card-body">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height">
                          <a href={{route('rider.index',['approval' => 0])}} style="color: inherit;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-primary">
                                        <svg class="svg-icon svg-danger" width="50" height="52" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height">
                         <a href={{route('riderequest.index')}} style="color: inherit;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-primary">
                                        <svg class="svg-icon svg-danger" width="50" height="52" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height">
                         <a href={{route('withdrawrequest.index')}} style="color: inherit;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-primary">
                                        <svg class="svg-icon svg-danger" width="50" height="52" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="card card-block card-stretch card-height">
                        <a href={{route('complaint.index')}} style="color: inherit;">
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="mm-cart-image text-primary">
                                        <svg class="svg-icon svg-danger" width="50" height="52" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
