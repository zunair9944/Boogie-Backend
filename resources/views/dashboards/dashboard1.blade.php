                    ...
                    <div class="card-body">
                        <ul class="list-inline p-0 m-0">
                            <li class="media align-items-start">
                                <a href="JavaScript:Void(0);"><img src="{{asset('images/user/1.jpg')}}"
                            ...
                            <li class="media align-items-start mt-3">
                                <a href="JavaScript:Void(0);"><img src="{{asset('images/user/5.jpg')}}"
                                        class="img-fluid avatar-60 rounded-small" alt="image"></a>
                                <div class="media-body ml-3">
                                    <div class="d-flex justify-content-between">
                                        <h5>Carolina Tens</h5>
                            ...
                            <li class="media align-items-start mt-3">
                                <a href="JavaScript:Void(0);"><img src="{{asset('images/user/4.jpg')}}"
                                        class="img-fluid avatar-60 rounded-small" alt="image"></a>
                                <div class="media-body ml-3">
                                    <div class="d-flex justify-content-between">
                                        <h5>Anna Mull</h5>
                    ...
                    <div class="card-body">
                        <ul class="list-inline p-0 m-0">
                            <li class="media align-items-center">
                                <a href="JavaScript:Void(0);"><img src="{{asset('images/layouts/layout-1/prod-1.jpg')}}"
                                        class="img-fluid avatar-60 rounded-small" alt="image"></a>
                                <div class="media-body ml-3">
                                    <h5>Full Tees</h5>
