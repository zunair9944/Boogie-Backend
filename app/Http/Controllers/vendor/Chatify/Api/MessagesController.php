...
// }
   ...
   public function pusherAuth(Request $request)
    ...
    public function fetch(Request $request)
    {
        ...
        // $upload = Upload::where('user_id',$user->profile_image_id)->first();
        // $image = str_replace("public/", "", $upload->file_name);
        // if(isset($image))
        // {
        ...
        $response = [
            'total' => $totalMessages,
            'profile_image' => getImagePath($user),//$profileImage,
            'name' => isset($user) ? $user->full_name : null,
            'last_page' => $lastPage,
