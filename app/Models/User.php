...
class User extends Authenticatable implements HasMedia
{
     ...
     */
    protected $with = array('riderRating','driverRating','userDetail','aboutMeDetail');
    // protected $fillable = [
    ...
    {
        return $this->hasMany(Card::class,'rider_id','id');
    }
    ...
    public function aboutMeDetail() {
        return $this->hasOne(AboutMeDetail::class, 'user_id', 'id');
    }
...
{
    return $this->belongsToMany(Service::class, 'driver_services', 'driver_id', 'service_id');
}
